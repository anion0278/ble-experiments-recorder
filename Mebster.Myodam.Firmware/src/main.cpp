...
#ifdef UNILEXA_01
    #define DEVICE_NAME "UNILEXA-UP20L"
    //#define DEVICE_NAME "UNILEXA-DEV-MM1"
    #define DEVICE_SERIAL_NO "2125001"
#endif

#ifdef UNILEXA_02
    #define DEVICE_NAME "MYODAM"
    //#define DEVICE_NAME "UNILEXA-DEV-MM1"
...
BLECharacteristic bleDeviceProductName("2A24",BLERead,"UNILEXA");
...
BLECharacteristic bleDeviceManufacturer("2A29",BLERead,"MEBSTER");
...
void turnOff(void){
    ...
    // Wire.end();                 // Wire is needed to read change in legs angle
