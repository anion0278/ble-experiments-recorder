 ...
 * @brief Driver for the Silicon Labs Si7210 Hall effect sensor
 ...
 #include "sl_i2caddr_instances.h"
 #include "sl_si7210.h"
 ...
 int main( void )
 {
   ...
   sl_si7210_init(sl_i2caddr_sensor);
   sl_si7210_measure(sl_i2caddr_sensor, 10000, &mTdata);
 ...
 * @retval SL_STATUS_TRANSMIT  I2C transmission error
 *****************************************************************************/
sl_status_t sl_si7210_read_register(byte i2caddr, uint8_t addr, uint8_t *data);
 ...
 * @retval SL_STATUS_TRANSMIT  I2C transmission error
 *****************************************************************************/
sl_status_t sl_si7210_write_register(byte i2caddr, uint8_t addr, uint8_t data);
